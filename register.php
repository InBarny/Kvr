...
<body>
    <div class="login-container">
        <form class="login-form" action="src/actions/register.php" method="post" enctype="multipart/form-data">
            <h2>Регистрация</h2>
            ...
            <label for="name">
                ...
                <input
                    ...
                    name="grup"
                    placeholder="Группа"
                    value="<?php echo old('grup') ?>"
                    <?php echo validationErrorAttr('grup'); ?>>
                <?php if (hasValidationError('grup')): ?>
                    <small><?php echo validationErrorMessage('grup'); ?></small>
                <?php endif; ?>
            </label>
